...
Name=$(curl -sS https://raw.githubusercontent.com/NeGamer01/Autoscript-vpn/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/NeGamer01/Autoscript-vpn/main/izin | grep $MYIP | awk '{print $3}')
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
echo -e " ${BICyan}[${BIWhite}01${BICyan}]${RED} •${NC} ${YELLOW}SSH MENU        $NC  ${BICyan}[${BIWhite}12${BICyan}]${RED} • ${NC}${CYAN}GEN-SSL / CERTV $NC"
...
echo -e "${BICyan}│ ${BOLD}${LIGHT}Developer = Andy Yuda                       ${NC}"
echo -e "${BICyan}│ ${BOLD}${LIGHT}Version   = SUPER LTS                       ${NC}"
